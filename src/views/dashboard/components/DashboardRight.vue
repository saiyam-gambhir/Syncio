...
<template>
  <section class="col-12 md:col-7 lg:col-9">
    ...
    <Carousel :value="connectionsStore.isSourceStore
        ? sourceAnnouncements
        : destinationAnnouncements
      " :numVisible="1" :numScroll="1" circular :autoplayInterval="5000" :showNavigators="false"
          ...
          <template #content>
            <div class="grid justify-content-between" :class="data.className">
              <div class="col-4">
                ...
                <a v-if="data.externalLink" :href="data.href" target="_blank" class="p-button font-bold mt-5">Learn
                  more</a>
