...
<template>
  <DialogWrapper :isVisible="connectionsStore.isDisconnectAndKeepRequested" title="Disconnect and Keep?" width="500px"
    ...
    <template #body>
      <section class="grid flex-column mt-1 px-3">
        ...
        <p class="mt-0">
          Any products currently in sync with this store will be unsynced, but
          will not be deleted.
        </p>
