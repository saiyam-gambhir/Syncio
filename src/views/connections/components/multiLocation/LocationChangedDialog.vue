  ...
  <DialogWrapper
    ...
    <template #body>
      <section class="mt-1 text-lg text-center">
        ...
        <p class="mt-0 px-2 line-height-3"><Strong>{{ location.storeName ?? location.store }}'s</Strong> products will be resynced to reflect the new location's inventory quantity.</p>
