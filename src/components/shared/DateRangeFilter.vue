...
<template>
  <VueDatePicker :clearable="false" :enable-time-picker="false" :ignore-time-validation="true" :max-date="maxDate"
    :month-change-on-scroll="false" :no-today="true" :partial-range="false" :preset-ranges="presetRanges"
    :timezone="timeZone" multi-calendars range v-model="date" />
</template>
